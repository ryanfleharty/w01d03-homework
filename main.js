...
for (let i=0; i < turtleMembers.length; i++){
    turtleMembers[i].toUpperCase();
    console.log(turtleMembers[i]);
};
...
/* Return of the Closets: Below, we've given you examples of Kristyn and Thom's closets modeled as data in JavaScript. Use this data to answer the following questions. */ 
